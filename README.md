...
```javascript
chi = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-chi@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-chi@umd/bundle.js"></script>
```
